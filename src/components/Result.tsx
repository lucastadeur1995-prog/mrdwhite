    ...
    return (
        <div className="result-container">
            ...
            <style>{`
                ...
                .progress-step.active .step-circle { background: #16a34a; color: black; }
                .progress-step.completed .step-circle { background: #16a34a; color: white; }
                ...
                .summary-grid span { color: #16a34a; font-weight: bold; }
                .emotional-validation { background: rgba(74, 222, 128, 0.1); border: 2px solid rgba(74, 222, 128, 0.3); border-radius: 12px; padding: 20px; margin-top: 20px; color: #16a34a; }
                .loading-box-custom { background: rgba(234, 179, 8, 0.1); border: 2px solid #16a34a; border-radius: 16px; padding: 40px; text-align: center; }
                ...
                .loading-step-item.active { color: #16a34a; font-weight: bold; }
                .progress-outer { width: 100%; height: 10px; background: rgba(255,255,255,0.2); border-radius: 5px; overflow: hidden; }
                .progress-inner { height: 100%; background: linear-gradient(90deg, #16a34a, #16a34a); width: 0%; transition: width 0.1s linear; }
                ...
                .video-delay-indicator { background: rgba(0,0,0,0.4); border: 2px solid #16a34a; border-radius: 12px; padding: 20px; margin-top: 20px; text-align: center; color: white; display: flex; flex-direction: column; align-items: center; gap: 15px; }
                ...
                .delay-progress-bar { height: 100%; background: linear-gradient(90deg, #16a34a, #16a34a); transition: width 1s linear; }
                ...
                .btn-green { background: linear-gradient(135deg, #16a34a, #059669); color: white; }
                .btn-yellow { background: linear-gradient(135deg, #16a34a, #ca8a04); color: black; }
                .btn-orange { background: linear-gradient(135deg, #16a34a, #166534); color: white; }
                ...
                .ventana-header-custom h2 { font-size: clamp(1.5rem, 6vw, 2.2rem); color: #16a34a; margin: 0; font-weight: 900; text-transform: uppercase; }
                ...
                .fase-number { background: linear-gradient(135deg, #16a34a, #166534); color: white; font-size: clamp(0.8rem, 3vw, 0.95rem); font-weight: 900; padding: 6px 14px; border-radius: 20px; }
                ...
                .fase-bullet-item { font-size: clamp(0.85rem, 3.5vw, 1rem); color: #16a34a; line-height: 1.5; }
                .fase-card-warning { background: rgba(234, 179, 8, 0.15); border-left: 4px solid #16a34a; padding: 12px; border-radius: 8px; font-size: clamp(0.85rem, 3.5vw, 1rem); color: #facc15; margin-bottom: 16px; }
                .fase-card-footer { display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 10px; }
                .fase-check { font-size: clamp(0.8rem, 3vw, 0.95rem); color: #16a34a; font-weight: 700; }
                ...
                @keyframes glow { from { text-shadow: 0 0 10px #16a34a, 0 0 20px #16a34a; } to { text-shadow: 0 0 20px #16a34a, 0 0 40px #16a34a, 0 0 60px #16a34a; } }
